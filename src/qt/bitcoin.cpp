...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. UFO can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "ufo:"))
        {
    ...
    app.setOrganizationName("UFO");
    app.setOrganizationDomain("we-have-no-domain-yet.nex");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("ufo-qt-testnet");
    else
        app.setApplicationName("ufo-qt");
